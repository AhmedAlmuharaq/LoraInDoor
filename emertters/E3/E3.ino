...
// ====================================================================
// EMITTER E3 — Place at CORNER: top-left (x=0, y=8)
// EMITTER_ID = 3  →  TDMA offset = 300 ms
// ====================================================================
const int EMITTER_ID = 3;
const int TX_OFFSET  = EMITTER_ID * 100;   // 300 ms
...
void setup() {
    ...
    Serial.println("E3 Ready — EMITTER_ID=3 — corner (0,8)");
}
