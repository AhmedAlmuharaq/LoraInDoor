...
// ====================================================================
// EMITTER E2 — Place at CORNER: top-right (x=6, y=8)
// EMITTER_ID = 2  →  TDMA offset = 200 ms
// ====================================================================
const int EMITTER_ID = 2;
const int TX_OFFSET  = EMITTER_ID * 100;   // 200 ms
...
void setup() {
    ...
    Serial.println("E2 Ready — EMITTER_ID=2 — corner (6,8)");
}
