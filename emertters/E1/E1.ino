...
// ====================================================================
// EMITTER E1 — Place at CORNER: bottom-right (x=6, y=0)
// EMITTER_ID = 1  →  TDMA offset = 100 ms
// ====================================================================
const int EMITTER_ID = 1;
const int TX_OFFSET  = EMITTER_ID * 100;   // 100 ms
...
void setup() {
    ...
    Serial.println("E1 Ready — EMITTER_ID=1 — corner (6,0)");
}
